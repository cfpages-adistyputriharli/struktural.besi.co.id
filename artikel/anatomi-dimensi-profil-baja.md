---
article_id: STR-03-02
title: "Tinggi, Lebar, Web, Flange, Lip, dan Radius pada Profil Baja"
slug: "anatomi-dimensi-profil-baja"
description: "Show which dimension is which across I/H, channel, T, and angle profiles"
status: outline
publication_date: "2025-08-06"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: STR-03
primary_intent: "Identify profile dimensions"
reader_community: "Besi.co.id"
reader_address: "Sobat Besi.co.id"
final_route: "/artikel/anatomi-dimensi-profil-baja.html"
...
# Tinggi, Lebar, Web, Flange, Lip, dan Radius pada Profil Baja

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Tinggi, Lebar, Web, Flange, Lip, dan Radius pada Profil Baja”
- **Reader and situation:** Receiver measuring a section
- **Reader outcome:** Show which dimension is which across I/H, channel, T, and angle profiles
- **Primary intent:** Identify profile dimensions
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Sobat Besi.co.id`
- **Natural variants:** `Kawan Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Excludes tolerance acceptance owned by STR-03-05 and entity behavior owned by STR-04 through STR-10
- **Final public route:** `/artikel/anatomi-dimensi-profil-baja.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Tinggi, Lebar, Web, Flange, Lip, dan Radius pada Profil Baja**.
...
- `/jual-besi-wf-tebing-tinggi` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-besi-unp-tebing-tinggi` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-besi-t-beam-tebing-tinggi` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-besi-siku-tebing-tinggi` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-besi-inp-tebing-tinggi` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-besi-h-beam-tebing-tinggi` — use only if it helps the reader's next step; verify the anchor describes the destination.

### Planned sibling articles

These are future routes. Do not link them as live until their HTML exists.

- `STR-03-01` → `/artikel/cara-membaca-tabel-profil-baja.html` — Cara Membaca Tabel Profil Baja Struktural
- `STR-03-03` → `/artikel/properti-penampang-profil-baja.html` — Area, Inersia, Section Modulus, dan Radius of Gyration
- `STR-03-04` → `/artikel/kalkulator-berat-teoretis-profil-baja.html` — Kalkulator Berat Teoretis Profil Baja: Rumus dan Batasnya
...
- **Tie back to this article:** Keep the explanation specific to “Tinggi, Lebar, Web, Flange, Lip, dan Radius pada Profil Baja”.
