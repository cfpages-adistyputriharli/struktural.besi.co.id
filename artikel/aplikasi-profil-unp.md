---
article_id: STR-07-04
title: "UNP sebagai Purlin, Girt, Edge Member, dan Support"
slug: "aplikasi-profil-unp"
description: "Map role-specific loads, orientation, restraint, cladding/equipment interfaces, corrosion, and connection questions"
status: outline
publication_date: "2025-11-16"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: STR-07
primary_intent: "Distinguish channel applications"
reader_community: "Besi.co.id"
reader_address: "Kawan Besi.co.id"
final_route: "/artikel/aplikasi-profil-unp.html"
...
# UNP sebagai Purlin, Girt, Edge Member, dan Support

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “UNP sebagai Purlin, Girt, Edge Member, dan Support”
- **Reader and situation:** Designer/buyer comparing secondary roles
- **Reader outcome:** Map role-specific loads, orientation, restraint, cladding/equipment interfaces, corrosion, and connection questions
- **Primary intent:** Distinguish channel applications
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Kawan Besi.co.id`
- **Natural variants:** `Sobat Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Excludes choosing sizes or replacing CNP without recalculation
- **Final public route:** `/artikel/aplikasi-profil-unp.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **UNP sebagai Purlin, Girt, Edge Member, dan Support**.
...
- **Exact Markdown to insert:** `![Ilustrasi Besi UNP 1](/wp-content/uploads/2024/06/Besi-UNP-1.jpg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `Besi UNP 1` as relevant content media; no pixels were inspected.
...
- `/jual-besi-unp-yogyakarta` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-besi-unp-yalimo` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-besi-unp-yahukimo` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-besi-unp-wonosobo` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-besi-unp-wonogiri` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-besi-unp-way-kanan` — use only if it helps the reader's next step; verify the anchor describes the destination.

### Planned sibling articles

These are future routes. Do not link them as live until their HTML exists.

- `STR-07-02` → `/artikel/cara-membaca-ukuran-unp.html` — Cara Membaca Ukuran dan Tabel UNP
- `STR-07-03` → `/artikel/torsion-dan-restraint-pada-unp.html` — Mengapa UNP Bisa Memuntir: Eccentricity dan Restraint
- `STR-07-05` → `/artikel/unp-back-to-back-dan-built-up.html` — UNP Back-to-Back dan Built-Up: Detail yang Harus Dijelaskan
- `STR-07-06` → `/artikel/checklist-penerimaan-unp.html` — Checklist Spesifikasi dan Penerimaan UNP
...
- **Tie back to this article:** Keep the explanation specific to “UNP sebagai Purlin, Girt, Edge Member, dan Support”.
