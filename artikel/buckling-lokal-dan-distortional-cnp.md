---
article_id: STR-08-04
title: "Local dan Distortional Buckling pada Profil CNP"
slug: "buckling-lokal-dan-distortional-cnp"
description: "Explain element slenderness, lips, restraint, holes, damage, and why cold-formed design differs"
status: outline
publication_date: "2025-12-15"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: STR-08
primary_intent: "Understand thin-wall failure concepts"
reader_community: "Besi.co.id"
reader_address: "Sobat Besi.co.id"
final_route: "/artikel/buckling-lokal-dan-distortional-cnp.html"
...
# Local dan Distortional Buckling pada Profil CNP

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Local dan Distortional Buckling pada Profil CNP”
- **Reader and situation:** Reviewer assuming thickness alone controls
- **Reader outcome:** Explain element slenderness, lips, restraint, holes, damage, and why cold-formed design differs
- **Primary intent:** Understand thin-wall failure concepts
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Sobat Besi.co.id`
- **Natural variants:** `Kawan Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Excludes calculation methods or capacities
- **Final public route:** `/artikel/buckling-lokal-dan-distortional-cnp.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Local dan Distortional Buckling pada Profil CNP**.
...
- **Exact Markdown to insert:** `![Ilustrasi Besi CNP](/wp-content/uploads/2024/06/Besi-CNP.jpg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `Besi CNP` as relevant content media; no pixels were inspected.
...
- `STR-08-03` → `/artikel/cnp-sebagai-purlin-dan-girt.html` — CNP sebagai Purlin dan Girt: Peran Bridging dan Restraint
- `STR-08-05` → `/artikel/sambungan-screw-dan-bolt-cnp.html` — Sambungan Screw dan Bolt pada CNP
- `STR-08-06` → `/artikel/handling-dan-penyimpanan-cnp.html` — Handling dan Penyimpanan CNP agar Tidak Melintir atau Penyok
...
- **Tie back to this article:** Keep the explanation specific to “Local dan Distortional Buckling pada Profil CNP”.
