---
article_id: STR-06-02
title: "Cara Membaca Ukuran dan Tabel INP"
slug: "cara-membaca-ukuran-inp"
description: "Map designation, flange geometry, dimensions, mass, axes, and source identity"
status: outline
publication_date: "2025-10-19"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: STR-06
primary_intent: "Interpret INP table data"
reader_community: "Besi.co.id"
reader_address: "Kawan Besi.co.id"
final_route: "/artikel/cara-membaca-ukuran-inp.html"
...
# Cara Membaca Ukuran dan Tabel INP

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Cara Membaca Ukuran dan Tabel INP”
- **Reader and situation:** Estimator checking legacy/new lists
- **Reader outcome:** Map designation, flange geometry, dimensions, mass, axes, and source identity
- **Primary intent:** Interpret INP table data
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Kawan Besi.co.id`
- **Natural variants:** `Sobat Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Excludes assuming tables from different series are interchangeable
- **Final public route:** `/artikel/cara-membaca-ukuran-inp.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Cara Membaca Ukuran dan Tabel INP**.
...
- **Exact Markdown to insert:** `![Ilustrasi Besi INP 1 6](/wp-content/uploads/2024/06/Besi-INP-1-6.jpg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `Besi INP 1 6` as relevant content media; no pixels were inspected.
...
- **Tie back to this article:** Keep the explanation specific to “Cara Membaca Ukuran dan Tabel INP”.
