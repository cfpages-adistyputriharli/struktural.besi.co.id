---
article_id: STR-07-02
title: "Cara Membaca Ukuran dan Tabel UNP"
slug: "cara-membaca-ukuran-unp"
description: "Map height, flange, web, thickness, radius, mass, axes, and source table"
status: outline
publication_date: "2025-11-09"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: STR-07
primary_intent: "Interpret UNP designation"
reader_community: "Besi.co.id"
reader_address: "Kawan Besi.co.id"
final_route: "/artikel/cara-membaca-ukuran-unp.html"
...
# Cara Membaca Ukuran dan Tabel UNP

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Cara Membaca Ukuran dan Tabel UNP”
- **Reader and situation:** Estimator checking channels
- **Reader outcome:** Map height, flange, web, thickness, radius, mass, axes, and source table
- **Primary intent:** Interpret UNP designation
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Kawan Besi.co.id`
- **Natural variants:** `Sobat Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Excludes capacity and generic table literacy owned by STR-03-01
- **Final public route:** `/artikel/cara-membaca-ukuran-unp.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Cara Membaca Ukuran dan Tabel UNP**.
...
- **Tie back to this article:** Keep the explanation specific to “Cara Membaca Ukuran dan Tabel UNP”.
