---
article_id: STR-08-03
title: "CNP sebagai Purlin dan Girt: Peran Bridging dan Restraint"
slug: "cnp-sebagai-purlin-dan-girt"
description: "Explain span/load inputs, orientation, bridging, sag rods, cladding restraint, lap/continuity, and serviceability"
status: outline
publication_date: "2025-12-11"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: STR-08
primary_intent: "Understand secondary-framing system inputs"
reader_community: "Besi.co.id"
reader_address: "Kawan Besi.co.id"
final_route: "/artikel/cnp-sebagai-purlin-dan-girt.html"
...
# CNP sebagai Purlin dan Girt: Peran Bridging dan Restraint

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “CNP sebagai Purlin dan Girt: Peran Bridging dan Restraint”
- **Reader and situation:** Owner reviewing roof/wall framing
- **Reader outcome:** Explain span/load inputs, orientation, bridging, sag rods, cladding restraint, lap/continuity, and serviceability
- **Primary intent:** Understand secondary-framing system inputs
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Kawan Besi.co.id`
- **Natural variants:** `Sobat Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Excludes member sizing and proprietary system design
- **Final public route:** `/artikel/cnp-sebagai-purlin-dan-girt.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **CNP sebagai Purlin dan Girt: Peran Bridging dan Restraint**.
...
- **Exact Markdown to insert:** `![Ilustrasi Harga Besi CNP](/wp-content/uploads/2024/06/Harga-Besi-CNP.jpg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `Harga Besi CNP` as relevant content media; no pixels were inspected.
...
- `/jual-besi-cnp-yogyakarta` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-besi-cnp-yalimo` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-besi-cnp-yahukimo` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-besi-cnp-wonosobo` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-besi-cnp-wonogiri` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-besi-cnp-way-kanan` — use only if it helps the reader's next step; verify the anchor describes the destination.

### Planned sibling articles

These are future routes. Do not link them as live until their HTML exists.

- `STR-08-01` → `/artikel/panduan-besi-cnp.html` — Besi CNP: Lip, Ketebalan, Restraint, dan Sistemnya
- `STR-08-02` → `/artikel/cara-membaca-ukuran-cnp.html` — Cara Membaca Ukuran dan Ketebalan CNP
- `STR-08-04` → `/artikel/buckling-lokal-dan-distortional-cnp.html` — Local dan Distortional Buckling pada Profil CNP
- `STR-08-05` → `/artikel/sambungan-screw-dan-bolt-cnp.html` — Sambungan Screw dan Bolt pada CNP
...
- **Tie back to this article:** Keep the explanation specific to “CNP sebagai Purlin dan Girt: Peran Bridging dan Restraint”.
