---
article_id: STR-10-05
title: "Double Angle dan Back-to-Back: Jarak, Connector, dan Korosi Celah"
slug: "double-angle-dan-back-to-back"
description: "Cover spacing, connectors, load sharing concept, drainage, coating access, pack rust, tolerance, and inspection"
status: outline
publication_date: "2026-02-04"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: STR-10
primary_intent: "Review paired-angle details"
reader_community: "Besi.co.id"
reader_address: "Teman Besi.co.id"
final_route: "/artikel/double-angle-dan-back-to-back.html"
...
# Double Angle dan Back-to-Back: Jarak, Connector, dan Korosi Celah

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Double Angle dan Back-to-Back: Jarak, Connector, dan Korosi Celah”
- **Reader and situation:** Fabricator/maintainer
- **Reader outcome:** Cover spacing, connectors, load sharing concept, drainage, coating access, pack rust, tolerance, and inspection
- **Primary intent:** Review paired-angle details
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Teman Besi.co.id`
- **Natural variants:** `Sobat Besi.co.id` and `Kawan Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Excludes built-up-member design and repair disposition
- **Final public route:** `/artikel/double-angle-dan-back-to-back.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Double Angle dan Back-to-Back: Jarak, Connector, dan Korosi Celah**.
...
- `STR-10-06` → `/artikel/checklist-penerimaan-besi-siku.html` — Checklist Spesifikasi dan Penerimaan Besi Siku
...
- **Tie back to this article:** Keep the explanation specific to “Double Angle dan Back-to-Back: Jarak, Connector, dan Korosi Celah”.
