---
article_id: STR-05-03
title: "H-Beam sebagai Kolom: Arah Sumbu, Bracing, dan Base"
slug: "h-beam-sebagai-kolom"
description: "Explain axial/bending interaction concept, effective length, weak-axis restraint, base interface, splices, and fire/protection questions"
status: outline
publication_date: "2025-10-02"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: STR-05
primary_intent: "Understand column-design inputs"
reader_community: "Besi.co.id"
reader_address: "Kawan Besi.co.id"
final_route: "/artikel/h-beam-sebagai-kolom.html"
...
# H-Beam sebagai Kolom: Arah Sumbu, Bracing, dan Base

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “H-Beam sebagai Kolom: Arah Sumbu, Bracing, dan Base”
- **Reader and situation:** Owner reviewing a column concept
- **Reader outcome:** Explain axial/bending interaction concept, effective length, weak-axis restraint, base interface, splices, and fire/protection questions
- **Primary intent:** Understand column-design inputs
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Kawan Besi.co.id`
- **Natural variants:** `Sobat Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Excludes selecting a size, base plate, or splice design
- **Final public route:** `/artikel/h-beam-sebagai-kolom.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **H-Beam sebagai Kolom: Arah Sumbu, Bracing, dan Base**.
...
- **Exact Markdown to insert:** `![Ilustrasi Besi T Beam 2](/wp-content/uploads/2024/06/Besi-T-Beam-2.jpg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `Besi T Beam 2` as relevant content media; no pixels were inspected.
...
- `/jual-besi-t-beam-yogyakarta` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-besi-t-beam-yalimo` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-besi-t-beam-yahukimo` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-besi-t-beam-wonosobo` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-besi-t-beam-wonogiri` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-besi-t-beam-way-kanan` — use only if it helps the reader's next step; verify the anchor describes the destination.

### Planned sibling articles

These are future routes. Do not link them as live until their HTML exists.

- `STR-05-01` → `/artikel/panduan-besi-h-beam.html` — Besi H-Beam: Anatomi, Peran, dan Bukti yang Harus Dicek
- `STR-05-02` → `/artikel/cara-membaca-ukuran-h-beam.html` — Cara Membaca Ukuran dan Tabel H-Beam
- `STR-05-04` → `/artikel/h-beam-pada-struktur-berat.html` — H-Beam pada Struktur Berat dan Bentang Besar: Kapan Namanya Menyesatkan
- `STR-05-05` → `/artikel/detail-interface-h-beam.html` — Splice, Stiffener, dan Base Interface pada H-Beam
...
- **Tie back to this article:** Keep the explanation specific to “H-Beam sebagai Kolom: Arah Sumbu, Bracing, dan Base”.
