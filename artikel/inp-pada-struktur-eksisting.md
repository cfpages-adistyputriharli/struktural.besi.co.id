---
article_id: STR-06-04
title: "INP pada Struktur Eksisting: Survei sebelum Penggantian"
slug: "inp-pada-struktur-eksisting"
description: "Record actual geometry, marks, corrosion, modifications, support, loads, records, testing needs, and temporary controls"
status: outline
publication_date: "2025-10-26"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: STR-06
primary_intent: "Survey legacy INP members"
reader_community: "Besi.co.id"
reader_address: "Sobat Besi.co.id"
final_route: "/artikel/inp-pada-struktur-eksisting.html"
...
# INP pada Struktur Eksisting: Survei sebelum Penggantian

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “INP pada Struktur Eksisting: Survei sebelum Penggantian”
- **Reader and situation:** Facility team replacing an old member
- **Reader outcome:** Record actual geometry, marks, corrosion, modifications, support, loads, records, testing needs, and temporary controls
- **Primary intent:** Survey legacy INP members
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Sobat Besi.co.id`
- **Natural variants:** `Kawan Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Excludes grade inference from appearance or replacement design
- **Final public route:** `/artikel/inp-pada-struktur-eksisting.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **INP pada Struktur Eksisting: Survei sebelum Penggantian**.
...
- **Exact Markdown to insert:** `![Ilustrasi Besi INP 1 1](/wp-content/uploads/2024/06/Besi-INP-1-1.jpg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `Besi INP 1 1` as relevant content media; no pixels were inspected.
...
- `/jual-besi-inp-yogyakarta` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-besi-inp-yalimo` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-besi-inp-yahukimo` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-besi-inp-wonosobo` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-besi-inp-wonogiri` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-besi-inp-way-kanan` — use only if it helps the reader's next step; verify the anchor describes the destination.

### Planned sibling articles

These are future routes. Do not link them as live until their HTML exists.

- `STR-06-02` → `/artikel/cara-membaca-ukuran-inp.html` — Cara Membaca Ukuran dan Tabel INP
- `STR-06-03` → `/artikel/inp-sebagai-balok-sekunder.html` — INP sebagai Balok Sekunder: Input yang Menentukan
- `STR-06-05` → `/artikel/sambungan-pada-profil-inp.html` — Sambungan pada Flange INP yang Tapered
- `STR-06-06` → `/artikel/checklist-pembelian-besi-inp.html` — Checklist Pembelian INP agar Tidak Salah Seri
...
- **Tie back to this article:** Keep the explanation specific to “INP pada Struktur Eksisting: Survei sebelum Penggantian”.
