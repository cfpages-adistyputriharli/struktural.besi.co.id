---
article_id: STR-06-03
title: "INP sebagai Balok Sekunder: Input yang Menentukan"
slug: "inp-sebagai-balok-sekunder"
description: "Cover span/support, load path, restraint, deflection, deck/interface, openings, connections, and availability"
status: outline
publication_date: "2025-10-22"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: STR-06
primary_intent: "Understand secondary-beam questions"
reader_community: "Besi.co.id"
reader_address: "Teman Besi.co.id"
final_route: "/artikel/inp-sebagai-balok-sekunder.html"
...
# INP sebagai Balok Sekunder: Input yang Menentukan

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “INP sebagai Balok Sekunder: Input yang Menentukan”
- **Reader and situation:** Owner reviewing an INP proposal
- **Reader outcome:** Cover span/support, load path, restraint, deflection, deck/interface, openings, connections, and availability
- **Primary intent:** Understand secondary-beam questions
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Teman Besi.co.id`
- **Natural variants:** `Sobat Besi.co.id` and `Kawan Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Excludes sizing or declaring INP adequate
- **Final public route:** `/artikel/inp-sebagai-balok-sekunder.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **INP sebagai Balok Sekunder: Input yang Menentukan**.
...
- **Exact Markdown to insert:** `![Ilustrasi Besi INP 1](/wp-content/uploads/2024/06/Besi-INP-1.jpg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `Besi INP 1` as relevant content media; no pixels were inspected.
...
- `STR-06-01` → `/artikel/panduan-besi-inp.html` — Besi INP: Identitas Profil I dan Istilah yang Perlu Diverifikasi
- `STR-06-02` → `/artikel/cara-membaca-ukuran-inp.html` — Cara Membaca Ukuran dan Tabel INP
- `STR-06-04` → `/artikel/inp-pada-struktur-eksisting.html` — INP pada Struktur Eksisting: Survei sebelum Penggantian
...
- **Tie back to this article:** Keep the explanation specific to “INP sebagai Balok Sekunder: Input yang Menentukan”.
