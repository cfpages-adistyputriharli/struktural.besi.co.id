---
article_id: STR-11-03
title: "INP vs WF: Nama Profil I Bukan Bukti Kesetaraan"
slug: "inp-vs-wf"
description: "Compare geometry, flange form, axes, tables, availability, connections, existing drawings, and evidence needed"
status: outline
publication_date: "2026-02-19"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: STR-11
primary_intent: "Compare I-profile series"
reader_community: "Besi.co.id"
reader_address: "Sobat Besi.co.id"
final_route: "/artikel/inp-vs-wf.html"
...
# INP vs WF: Nama Profil I Bukan Bukti Kesetaraan

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “INP vs WF: Nama Profil I Bukan Bukti Kesetaraan”
- **Reader and situation:** Buyer offered INP instead of WF
- **Reader outcome:** Compare geometry, flange form, axes, tables, availability, connections, existing drawings, and evidence needed
- **Primary intent:** Compare I-profile series
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Sobat Besi.co.id`
- **Natural variants:** `Kawan Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Excludes accepting equivalence; entities remain STR-06-01 and STR-04-01
- **Final public route:** `/artikel/inp-vs-wf.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **INP vs WF: Nama Profil I Bukan Bukti Kesetaraan**.
...
- **Exact Markdown to insert:** `![Ilustrasi Besi INP 1 4](/wp-content/uploads/2024/06/Besi-INP-1-4.jpg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `Besi INP 1 4` as relevant content media; no pixels were inspected.
...
- `STR-11-01` → `/artikel/wf-vs-h-beam.html` — WF vs H-Beam: Membandingkan Geometri, Peran, dan Bukti
- `STR-11-02` → `/artikel/unp-vs-cnp.html` — UNP vs CNP: Kanal Canai Panas dan Canai Dingin
- `STR-11-04` → `/artikel/besi-siku-vs-kanal.html` — Besi Siku vs Kanal untuk Bracing dan Support
...
- **Tie back to this article:** Keep the explanation specific to “INP vs WF: Nama Profil I Bukan Bukti Kesetaraan”.
