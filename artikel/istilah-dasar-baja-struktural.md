---
article_id: STR-01-02
title: "Besi, Baja, Profil, Penampang, dan Member: Istilah yang Sering Tertukar"
slug: "istilah-dasar-baja-struktural"
description: "Distinguish material, product form, cross-section, member, structure, and Indonesian trade usage"
status: outline
publication_date: "2025-06-19"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: STR-01
primary_intent: "Use correct structural-steel terms"
reader_community: "Besi.co.id"
reader_address: "Sobat Besi.co.id"
final_route: "/artikel/istilah-dasar-baja-struktural.html"
...
# Besi, Baja, Profil, Penampang, dan Member: Istilah yang Sering Tertukar

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Besi, Baja, Profil, Penampang, dan Member: Istilah yang Sering Tertukar”
- **Reader and situation:** Buyer reading inconsistent quotations
- **Reader outcome:** Distinguish material, product form, cross-section, member, structure, and Indonesian trade usage
- **Primary intent:** Use correct structural-steel terms
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Sobat Besi.co.id`
- **Natural variants:** `Kawan Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Excludes grade identity owned by STR-02-01 and product selection owned by STR-11-01
- **Final public route:** `/artikel/istilah-dasar-baja-struktural.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Besi, Baja, Profil, Penampang, dan Member: Istilah yang Sering Tertukar**.
...
- **Exact Markdown to insert:** `![Ilustrasi Besi WF](/wp-content/uploads/2024/06/Besi-WF.jpg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `Besi WF` as relevant content media; no pixels were inspected.
...
- `/jual-besi-wf-yogyakarta` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-besi-wf-yalimo` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-besi-wf-yahukimo` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-besi-wf-wonosobo` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-besi-wf-wonogiri` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-besi-wf-way-kanan` — use only if it helps the reader's next step; verify the anchor describes the destination.

### Planned sibling articles

These are future routes. Do not link them as live until their HTML exists.

- `STR-01-01` → `/artikel/panduan-profil-baja-struktural.html` — Panduan Profil Baja Struktural: Dari Nama hingga Penggunaan
- `STR-01-03` → `/artikel/sifat-mekanik-baja-struktural.html` — Kekuatan, Kekakuan, Daktilitas, dan Ketangguhan Baja
- `STR-01-04` → `/artikel/profil-canai-panas-canai-dingin-built-up.html` — Profil Canai Panas, Canai Dingin, dan Built-Up
...
- **Tie back to this article:** Keep the explanation specific to “Besi, Baja, Profil, Penampang, dan Member: Istilah yang Sering Tertukar”.
