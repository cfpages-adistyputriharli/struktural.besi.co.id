---
article_id: STR-08-01
title: "Besi CNP: Lip, Ketebalan, Restraint, dan Sistemnya"
slug: "panduan-besi-cnp"
description: "Explain cold-formed identity, lips, thin-wall behavior concepts, restraint/bridging, roles, handling, and evidence"
status: outline
publication_date: "2025-12-01"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: STR-08
primary_intent: "Understand lipped C channels"
reader_community: "Besi.co.id"
reader_address: "Sobat Besi.co.id"
final_route: "/artikel/panduan-besi-cnp.html"
...
# Besi CNP: Lip, Ketebalan, Restraint, dan Sistemnya

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Besi CNP: Lip, Ketebalan, Restraint, dan Sistemnya”
- **Reader and situation:** Buyer researching CNP
- **Reader outcome:** Explain cold-formed identity, lips, thin-wall behavior concepts, restraint/bridging, roles, handling, and evidence
- **Primary intent:** Understand lipped C channels
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Sobat Besi.co.id`
- **Natural variants:** `Kawan Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Excludes UNP comparison owned by STR-11-02 and `/besi-cnp/` sales
- **Final public route:** `/artikel/panduan-besi-cnp.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Besi CNP: Lip, Ketebalan, Restraint, dan Sistemnya**.
...
- **Tie back to this article:** Keep the explanation specific to “Besi CNP: Lip, Ketebalan, Restraint, dan Sistemnya”.
