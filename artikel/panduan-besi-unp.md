---
article_id: STR-07-01
title: "Besi UNP: Anatomi Kanal U, Asimetri, dan Batasnya"
slug: "panduan-besi-unp"
description: "Explain open-section geometry, centroid/shear-center concept, axes, torsion tendency, common roles, and evidence"
status: outline
publication_date: "2025-11-06"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: STR-07
primary_intent: "Understand UNP behavior concepts"
reader_community: "Besi.co.id"
reader_address: "Teman Besi.co.id"
final_route: "/artikel/panduan-besi-unp.html"
...
# Besi UNP: Anatomi Kanal U, Asimetri, dan Batasnya

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Besi UNP: Anatomi Kanal U, Asimetri, dan Batasnya”
- **Reader and situation:** Buyer researching U-channels
- **Reader outcome:** Explain open-section geometry, centroid/shear-center concept, axes, torsion tendency, common roles, and evidence
- **Primary intent:** Understand UNP behavior concepts
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Teman Besi.co.id`
- **Natural variants:** `Sobat Besi.co.id` and `Kawan Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Excludes CNP comparison owned by STR-11-02 and `/besi-unp/` sales
- **Final public route:** `/artikel/panduan-besi-unp.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Besi UNP: Anatomi Kanal U, Asimetri, dan Batasnya**.
...
- **Tie back to this article:** Keep the explanation specific to “Besi UNP: Anatomi Kanal U, Asimetri, dan Batasnya”.
