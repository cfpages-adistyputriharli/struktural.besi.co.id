---
article_id: STR-04-01
title: "Besi WF: Anatomi, Perilaku, dan Batas Penggunaannya"
slug: "panduan-besi-wf"
description: "Explain geometry, axes, rolled-profile identity, common structural roles, restraint, evidence, and limitations"
status: outline
publication_date: "2025-08-28"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: STR-04
primary_intent: "Understand WF as an entity"
reader_community: "Besi.co.id"
reader_address: "Teman Besi.co.id"
final_route: "/artikel/panduan-besi-wf.html"
...
# Besi WF: Anatomi, Perilaku, dan Batas Penggunaannya

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Besi WF: Anatomi, Perilaku, dan Batas Penggunaannya”
- **Reader and situation:** Buyer researching wide-flange profiles
- **Reader outcome:** Explain geometry, axes, rolled-profile identity, common structural roles, restraint, evidence, and limitations
- **Primary intent:** Understand WF as an entity
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Teman Besi.co.id`
- **Natural variants:** `Sobat Besi.co.id` and `Kawan Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Excludes H-Beam comparison owned by STR-11-01 and `/besi-wf/` sales
- **Final public route:** `/artikel/panduan-besi-wf.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Besi WF: Anatomi, Perilaku, dan Batas Penggunaannya**.
...
- **Tie back to this article:** Keep the explanation specific to “Besi WF: Anatomi, Perilaku, dan Batas Penggunaannya”.
