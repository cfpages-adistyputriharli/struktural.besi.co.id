---
article_id: STR-09-01
title: "Profil T-Beam: Anatomi, Asimetri, dan Orientasi"
slug: "panduan-profil-t-beam"
description: "Explain flange/stem geometry, centroid orientation, asymmetric bending concepts, rolled/split identity, roles, and evidence"
status: outline
publication_date: "2025-12-25"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: STR-09
primary_intent: "Understand T-section identity"
reader_community: "Besi.co.id"
reader_address: "Teman Besi.co.id"
final_route: "/artikel/panduan-profil-t-beam.html"
...
# Profil T-Beam: Anatomi, Asimetri, dan Orientasi

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Profil T-Beam: Anatomi, Asimetri, dan Orientasi”
- **Reader and situation:** Buyer researching T profiles
- **Reader outcome:** Explain flange/stem geometry, centroid orientation, asymmetric bending concepts, rolled/split identity, roles, and evidence
- **Primary intent:** Understand T-section identity
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Teman Besi.co.id`
- **Natural variants:** `Sobat Besi.co.id` and `Kawan Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Excludes member sizing and `/besi-t-beam/` sales
- **Final public route:** `/artikel/panduan-profil-t-beam.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Profil T-Beam: Anatomi, Asimetri, dan Orientasi**.
...
- **Exact Markdown to insert:** `![Ilustrasi Besi T Beam 3](/wp-content/uploads/2024/06/Besi-T-Beam-3.jpg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `Besi T Beam 3` as relevant content media; no pixels were inspected.
...
- **Tie back to this article:** Keep the explanation specific to “Profil T-Beam: Anatomi, Asimetri, dan Orientasi”.
