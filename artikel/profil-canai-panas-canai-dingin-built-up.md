---
article_id: STR-01-04
title: "Profil Canai Panas, Canai Dingin, dan Built-Up"
slug: "profil-canai-panas-canai-dingin-built-up"
description: "Explain production route, geometry, thickness, residual-stress concept, connections, and documentation implications"
status: outline
publication_date: "2025-06-26"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: STR-01
primary_intent: "Distinguish production families"
reader_community: "Besi.co.id"
reader_address: "Sobat Besi.co.id"
final_route: "/artikel/profil-canai-panas-canai-dingin-built-up.html"
...
# Profil Canai Panas, Canai Dingin, dan Built-Up

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Profil Canai Panas, Canai Dingin, dan Built-Up”
- **Reader and situation:** Buyer comparing similar-looking shapes
- **Reader outcome:** Explain production route, geometry, thickness, residual-stress concept, connections, and documentation implications
- **Primary intent:** Distinguish production families
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Sobat Besi.co.id`
- **Natural variants:** `Kawan Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Excludes selecting a system or capacity; CNP specifics belong to STR-08-01
- **Final public route:** `/artikel/profil-canai-panas-canai-dingin-built-up.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Profil Canai Panas, Canai Dingin, dan Built-Up**.
...
- `STR-01-02` → `/artikel/istilah-dasar-baja-struktural.html` — Besi, Baja, Profil, Penampang, dan Member: Istilah yang Sering Tertukar
- `STR-01-03` → `/artikel/sifat-mekanik-baja-struktural.html` — Kekuatan, Kekakuan, Daktilitas, dan Ketangguhan Baja
- `STR-01-05` → `/artikel/sejarah-standardisasi-profil-baja.html` — Mengapa Profil Baja Distandardisasi
- `STR-01-06` → `/artikel/mitos-pemilihan-profil-baja.html` — Mitos Profil Baja: Lebih Berat Selalu Lebih Kuat?
...
- **Tie back to this article:** Keep the explanation specific to “Profil Canai Panas, Canai Dingin, dan Built-Up”.
