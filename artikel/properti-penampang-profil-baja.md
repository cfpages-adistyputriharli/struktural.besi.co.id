---
article_id: STR-03-03
title: "Area, Inersia, Section Modulus, dan Radius of Gyration"
slug: "properti-penampang-profil-baja"
description: "Explain what each property describes, axis dependence, and why equal mass can behave differently"
status: outline
publication_date: "2025-08-09"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: STR-03
primary_intent: "Understand section-property concepts"
reader_community: "Besi.co.id"
reader_address: "Sobat Besi.co.id"
final_route: "/artikel/properti-penampang-profil-baja.html"
...
# Area, Inersia, Section Modulus, dan Radius of Gyration

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Area, Inersia, Section Modulus, dan Radius of Gyration”
- **Reader and situation:** Non-engineer reading technical tables
- **Reader outcome:** Explain what each property describes, axis dependence, and why equal mass can behave differently
- **Primary intent:** Understand section-property concepts
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Sobat Besi.co.id`
- **Natural variants:** `Kawan Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Excludes member design formulas and capacity claims; STR-12-03 owns design use
- **Final public route:** `/artikel/properti-penampang-profil-baja.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Area, Inersia, Section Modulus, dan Radius of Gyration**.
...
- **Tie back to this article:** Keep the explanation specific to “Area, Inersia, Section Modulus, dan Radius of Gyration”.
