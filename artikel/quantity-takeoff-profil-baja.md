---
article_id: STR-13-01
title: "Quantity Takeoff Profil Baja: Panjang, Berat, Waste, dan Aksesori"
slug: "quantity-takeoff-profil-baja"
description: "Separate member marks, cut lengths, catalog mass, offcuts, plates, bolts, coating, revisions, and assumptions"
status: outline
publication_date: "2026-04-03"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: STR-13
primary_intent: "Build a traceable takeoff"
reader_community: "Besi.co.id"
reader_address: "Teman Besi.co.id"
final_route: "/artikel/quantity-takeoff-profil-baja.html"
...
# Quantity Takeoff Profil Baja: Panjang, Berat, Waste, dan Aksesori

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Quantity Takeoff Profil Baja: Panjang, Berat, Waste, dan Aksesori”
- **Reader and situation:** Estimator using drawings
- **Reader outcome:** Separate member marks, cut lengths, catalog mass, offcuts, plates, bolts, coating, revisions, and assumptions
- **Primary intent:** Build a traceable takeoff
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Teman Besi.co.id`
- **Natural variants:** `Sobat Besi.co.id` and `Kawan Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Excludes fabrication labor/rates and capacity; STR-03-04 owns simple mass calculation
- **Final public route:** `/artikel/quantity-takeoff-profil-baja.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Quantity Takeoff Profil Baja: Panjang, Berat, Waste, dan Aksesori**.
...
- `STR-13-02` → `/artikel/anatomi-biaya-pengadaan-profil-baja.html` — Anatomi Biaya Pengadaan Profil Baja
- `STR-13-03` → `/artikel/bid-leveling-penawaran-profil-baja.html` — Bid Leveling Penawaran Profil Baja
...
- **Tie back to this article:** Keep the explanation specific to “Quantity Takeoff Profil Baja: Panjang, Berat, Waste, dan Aksesori”.
