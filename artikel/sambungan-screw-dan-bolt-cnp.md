---
article_id: STR-08-05
title: "Sambungan Screw dan Bolt pada CNP"
slug: "sambungan-screw-dan-bolt-cnp"
description: "Cover edge distance concept, hole/fastener compatibility, bearing/tear-out concepts, lap, access, corrosion, and inspection"
status: outline
publication_date: "2025-12-18"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: STR-08
primary_intent: "Review thin-profile fastening inputs"
reader_community: "Besi.co.id"
reader_address: "Kawan Besi.co.id"
final_route: "/artikel/sambungan-screw-dan-bolt-cnp.html"
...
# Sambungan Screw dan Bolt pada CNP

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Sambungan Screw dan Bolt pada CNP”
- **Reader and situation:** Installer/fabricator coordinating CNP
- **Reader outcome:** Cover edge distance concept, hole/fastener compatibility, bearing/tear-out concepts, lap, access, corrosion, and inspection
- **Primary intent:** Review thin-profile fastening inputs
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Kawan Besi.co.id`
- **Natural variants:** `Sobat Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Excludes fastener selection, spacing, or connection design
- **Final public route:** `/artikel/sambungan-screw-dan-bolt-cnp.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Sambungan Screw dan Bolt pada CNP**.
...
- **Exact Markdown to insert:** `![Ilustrasi Besi CNP Harga](/wp-content/uploads/2024/06/Besi-CNP-Harga.jpg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `Besi CNP Harga` as relevant content media; no pixels were inspected.
...
- **Tie back to this article:** Keep the explanation specific to “Sambungan Screw dan Bolt pada CNP”.
