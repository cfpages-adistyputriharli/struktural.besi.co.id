---
article_id: STR-01-03
title: "Kekuatan, Kekakuan, Daktilitas, dan Ketangguhan Baja"
slug: "sifat-mekanik-baja-struktural"
description: "Explain why these properties differ and what evidence can support each claim"
status: outline
...
final_route: "/artikel/sifat-mekanik-baja-struktural.html"
...
# Kekuatan, Kekakuan, Daktilitas, dan Ketangguhan Baja

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Kekuatan, Kekakuan, Daktilitas, dan Ketangguhan Baja”
- **Reader and situation:** Non-engineer evaluating “strong” claims
- **Reader outcome:** Explain why these properties differ and what evidence can support each claim
- **Primary intent:** Distinguish mechanical properties
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Teman Besi.co.id`
- **Natural variants:** `Sobat Besi.co.id` and `Kawan Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Excludes member adequacy owned by qualified design under STR-12-03
- **Final public route:** `/artikel/sifat-mekanik-baja-struktural.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Kekuatan, Kekakuan, Daktilitas, dan Ketangguhan Baja**.
...
- **Tie back to this article:** Keep the explanation specific to “Kekuatan, Kekakuan, Daktilitas, dan Ketangguhan Baja”.
