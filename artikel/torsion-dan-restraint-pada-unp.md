---
article_id: STR-07-03
title: "Mengapa UNP Bisa Memuntir: Eccentricity dan Restraint"
slug: "torsion-dan-restraint-pada-unp"
description: "Explain load application, shear-center concept, lateral restraint, orientation, connections, and built-up options"
status: outline
publication_date: "2025-11-13"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: STR-07
primary_intent: "Understand channel twist risk"
reader_community: "Besi.co.id"
reader_address: "Kawan Besi.co.id"
final_route: "/artikel/torsion-dan-restraint-pada-unp.html"
...
# Mengapa UNP Bisa Memuntir: Eccentricity dan Restraint

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Mengapa UNP Bisa Memuntir: Eccentricity dan Restraint”
- **Reader and situation:** Owner seeing an unrestrained channel
- **Reader outcome:** Explain load application, shear-center concept, lateral restraint, orientation, connections, and built-up options
- **Primary intent:** Understand channel twist risk
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Kawan Besi.co.id`
- **Natural variants:** `Sobat Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Excludes torsional/member design
- **Final public route:** `/artikel/torsion-dan-restraint-pada-unp.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Mengapa UNP Bisa Memuntir: Eccentricity dan Restraint**.
...
- **Exact Markdown to insert:** `![Ilustrasi Besi UNP](/wp-content/uploads/2024/06/Besi-UNP.jpg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `Besi UNP` as relevant content media; no pixels were inspected.
...
- `STR-07-01` → `/artikel/panduan-besi-unp.html` — Besi UNP: Anatomi Kanal U, Asimetri, dan Batasnya
- `STR-07-02` → `/artikel/cara-membaca-ukuran-unp.html` — Cara Membaca Ukuran dan Tabel UNP
- `STR-07-04` → `/artikel/aplikasi-profil-unp.html` — UNP sebagai Purlin, Girt, Edge Member, dan Support
...
- **Tie back to this article:** Keep the explanation specific to “Mengapa UNP Bisa Memuntir: Eccentricity dan Restraint”.
