---
article_id: STR-07-05
title: "UNP Back-to-Back dan Built-Up: Detail yang Harus Dijelaskan"
slug: "unp-back-to-back-dan-built-up"
description: "Cover spacing, connectors, load sharing, corrosion/inspection access, tolerances, and drawing evidence"
status: outline
publication_date: "2025-11-21"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: STR-07
primary_intent: "Review paired-channel concepts"
reader_community: "Besi.co.id"
reader_address: "Sobat Besi.co.id"
final_route: "/artikel/unp-back-to-back-dan-built-up.html"
...
# UNP Back-to-Back dan Built-Up: Detail yang Harus Dijelaskan

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “UNP Back-to-Back dan Built-Up: Detail yang Harus Dijelaskan”
- **Reader and situation:** Fabricator seeing a double-channel member
- **Reader outcome:** Cover spacing, connectors, load sharing, corrosion/inspection access, tolerances, and drawing evidence
- **Primary intent:** Review paired-channel concepts
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Sobat Besi.co.id`
- **Natural variants:** `Kawan Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Excludes built-up-member design or connector sizing
- **Final public route:** `/artikel/unp-back-to-back-dan-built-up.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **UNP Back-to-Back dan Built-Up: Detail yang Harus Dijelaskan**.
...
- **Tie back to this article:** Keep the explanation specific to “UNP Back-to-Back dan Built-Up: Detail yang Harus Dijelaskan”.
