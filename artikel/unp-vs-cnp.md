---
article_id: STR-11-02
title: "UNP vs CNP: Kanal Canai Panas dan Canai Dingin"
slug: "unp-vs-cnp"
description: "Contrast production, geometry, thickness, buckling/restraint concepts, connections, coating, handling, and typical systems"
status: outline
publication_date: "2026-02-16"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: STR-11
primary_intent: "Compare channel families"
reader_community: "Besi.co.id"
reader_address: "Kawan Besi.co.id"
final_route: "/artikel/unp-vs-cnp.html"
...
# UNP vs CNP: Kanal Canai Panas dan Canai Dingin

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “UNP vs CNP: Kanal Canai Panas dan Canai Dingin”
- **Reader and situation:** Buyer comparing U and lipped C profiles
- **Reader outcome:** Contrast production, geometry, thickness, buckling/restraint concepts, connections, coating, handling, and typical systems
- **Primary intent:** Compare channel families
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Kawan Besi.co.id`
- **Natural variants:** `Sobat Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Excludes profile-specific guides STR-07-01/STR-08-01 and member design
- **Final public route:** `/artikel/unp-vs-cnp.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **UNP vs CNP: Kanal Canai Panas dan Canai Dingin**.
...
- **Exact Markdown to insert:** `![Ilustrasi Kanal UNP](/wp-content/uploads/2024/06/Kanal-UNP.jpg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `Kanal UNP` as relevant content media; no pixels were inspected.
...
- **Tie back to this article:** Keep the explanation specific to “UNP vs CNP: Kanal Canai Panas dan Canai Dingin”.
