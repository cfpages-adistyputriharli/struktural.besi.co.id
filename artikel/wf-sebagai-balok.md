---
article_id: STR-04-03
title: "Besi WF sebagai Balok: Sumbu Kuat, Restraint, dan Serviceability"
slug: "wf-sebagai-balok"
description: "Explain orientation, lateral restraint, unbraced length, deflection, vibration, openings, and connection inputs"
status: outline
publication_date: "2025-09-05"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: STR-04
primary_intent: "Understand WF beam questions"
reader_community: "Besi.co.id"
reader_address: "Sobat Besi.co.id"
final_route: "/artikel/wf-sebagai-balok.html"
...
# Besi WF sebagai Balok: Sumbu Kuat, Restraint, dan Serviceability

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Besi WF sebagai Balok: Sumbu Kuat, Restraint, dan Serviceability”
- **Reader and situation:** Owner reviewing a beam concept
- **Reader outcome:** Explain orientation, lateral restraint, unbraced length, deflection, vibration, openings, and connection inputs
- **Primary intent:** Understand WF beam questions
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Sobat Besi.co.id`
- **Natural variants:** `Kawan Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Excludes selecting a size or span; STR-12-03 owns design boundary
- **Final public route:** `/artikel/wf-sebagai-balok.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Besi WF sebagai Balok: Sumbu Kuat, Restraint, dan Serviceability**.
...
- **Exact Markdown to insert:** `![Ilustrasi Besi WF 4](/wp-content/uploads/2024/06/Besi-WF-4.jpg)`
...
- `STR-04-01` → `/artikel/panduan-besi-wf.html` — Besi WF: Anatomi, Perilaku, dan Batas Penggunaannya
- `STR-04-02` → `/artikel/cara-membaca-ukuran-besi-wf.html` — Cara Membaca Ukuran dan Tabel Besi WF
- `STR-04-04` → `/artikel/wf-untuk-portal-dan-rangka.html` — Besi WF pada Portal dan Rangka Bangunan
...
- **Tie back to this article:** Keep the explanation specific to “Besi WF sebagai Balok: Sumbu Kuat, Restraint, dan Serviceability”.
