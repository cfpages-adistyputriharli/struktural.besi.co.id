---
article_id: STR-04-04
title: "Besi WF pada Portal dan Rangka Bangunan"
slug: "wf-untuk-portal-dan-rangka"
description: "Cover beam-column continuity, haunch concept, bracing, bases, envelope, fabrication, erection, and future expansion"
status: outline
publication_date: "2025-09-10"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: STR-04
primary_intent: "Understand frame-role implications"
reader_community: "Besi.co.id"
reader_address: "Kawan Besi.co.id"
final_route: "/artikel/wf-untuk-portal-dan-rangka.html"
...
# Besi WF pada Portal dan Rangka Bangunan

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Besi WF pada Portal dan Rangka Bangunan”
- **Reader and situation:** Owner planning a warehouse/frame
- **Reader outcome:** Cover beam-column continuity, haunch concept, bracing, bases, envelope, fabrication, erection, and future expansion
- **Primary intent:** Understand frame-role implications
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Kawan Besi.co.id`
- **Natural variants:** `Sobat Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Excludes frame design and H-Beam comparison owned by STR-11-01
- **Final public route:** `/artikel/wf-untuk-portal-dan-rangka.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Besi WF pada Portal dan Rangka Bangunan**.
...
- **Exact Markdown to insert:** `![Ilustrasi Rangka Besi WF](/wp-content/uploads/2024/06/Rangka-Besi-WF.jpg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `Rangka Besi WF` as relevant content media; no pixels were inspected.
...
- `STR-04-02` → `/artikel/cara-membaca-ukuran-besi-wf.html` — Cara Membaca Ukuran dan Tabel Besi WF
- `STR-04-03` → `/artikel/wf-sebagai-balok.html` — Besi WF sebagai Balok: Sumbu Kuat, Restraint, dan Serviceability
- `STR-04-05` → `/artikel/sambungan-pada-profil-wf.html` — Detail Sambungan yang Umum pada Profil WF
- `STR-04-06` → `/artikel/checklist-penerimaan-besi-wf.html` — Checklist Spesifikasi dan Penerimaan Besi WF
...
- **Tie back to this article:** Keep the explanation specific to “Besi WF pada Portal dan Rangka Bangunan”.
